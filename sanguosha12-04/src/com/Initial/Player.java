...
public class Player {
	...
	public Player(Character character, int hp,String shengfe) {
		this.character = character;
		this.hp = hp;
		this.shengfe = shengfe;
	...
	public void giveCard(Player who) {
		...
		for (int i = 0; i < 4; i++) {
			...
			System.out.print("[手牌"+Initial.listCard.toArray()[0]+"]" + "\t");
...
//		}
	...
	public String getShengfe() {
		return shengfe;
	}

	public void setShengfe(String shengfe) {
		this.shengfe = shengfe;
	}
